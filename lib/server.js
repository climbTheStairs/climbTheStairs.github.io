...
const respond = (req, res) => {
    ...
    if (blacklist.includes(req.getIp()))
        return res.clientErr(403, "Your IP address has been blacklisted. If you believe this is a mistake, please contact me.")
    if (!req.headers.hasOwnProperty("host"))
        return res.clientErr(400, "Your request is missing the Host header.")
    if (!req.isOnion())
